...
link1_status=$(curl -Is http://vm.abcd.tools/windows_server/en_windows_server_2016_vl_x64_by_AG_08.2018.iso | grep HTTP | cut -f2 -d" ")
link2_status=$(curl -Is http://vm.abcd.tools/windows_server/en_windows_server_2016_vl_x64_by_AG_08.2018.iso | grep HTTP | cut -f2 -d" ")
#sudo wget -P /mediabots http://vm.abcd.tools/windows_server/en_windows_server_2016_vl_x64_by_AG_08.2018.iso # Windows Server 2016 
if [ $link1_status = "200" ] ; then 
	sudo wget -P /mediabots http://vm.abcd.tools/windows_server/en_windows_server_2016_vl_x64_by_AG_08.2018.iso
